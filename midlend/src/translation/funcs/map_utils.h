#ifndef MASIK_IR_BACKEND_SRC_TRANSLATION_FUNCS_MAP_UTILS_H
#define MASIK_IR_BACKEND_SRC_TRANSLATION_FUNCS_MAP_UTILS_H
...
#endif /*MASIK_IR_BACKEND_SRC_TRANSLATION_FUNCS_MAP_UTILS_H*/